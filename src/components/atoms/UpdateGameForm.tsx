...
const UpdateGameForm = ({id, updateTable}:UpdateGameFormProps) => {
        ...
        Axios
            ...
            .then((response) => {
                setFormData({
                    ...
                    teamLocal: response.data.teamLocal,
                    teamAway: response.data.teamAway,
                    type: response.data.type,
                    date: moment.utc(moment(response.data.date).format()),
